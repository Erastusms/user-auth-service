...
import type { RequestMeta, RegisterResult, LoginResult, MeResult, RefreshResult, RevokeAllResult } from './auth.types';
...
export declare function getMe(userId: string, sessionId: string): Promise<MeResult>;
